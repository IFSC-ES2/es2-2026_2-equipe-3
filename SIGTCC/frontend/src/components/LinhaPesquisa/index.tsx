...
export function LinhaPesquisaInput({linhas, onChange}: LinhaPesquisaInputProps) {
  ...
  const processarAdicao = (e?: React.MouseEvent<HTMLButtonElement> | KeyboardEvent<HTMLInputElement>) => {
    ...
    if (linhas.some(linha => linha.toLowerCase() === textoFormatado.toLowerCase())) {
